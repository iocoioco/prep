...
namespace Pre_Processor
{
    internal class wk
    {
        ...
        public static double PearsonCorrelationCalculation(double[] values1, double[] values2)
        {
        ...
        public static int directory_분전후(int date_int, int updn, string stock)
        {
            ...
            if (updn == 0)
            {
                while (true)
                {
                    ...
                    if (File.Exists(Path.Combine(@"C:\BJS\분\" + date_string, stock + ".txt")))
